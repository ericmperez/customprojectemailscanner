...
- description: A detailed description of everything being requested in the licitación. Include specific items, quantities, units, materials, equipment models, locations of work, and any technical specifications mentioned in the PDF. Be thorough — 3-5 sentences. List all key deliverables. If the document has a table of items, list each item with its quantity and unit. IMPORTANT: In PR government PDFs, item tables often have "CantidadU/M" or "Cantidad" and "U/M" columns on the FAR RIGHT side of the table. The number is the quantity and the code next to it is the unit (e.g., "100 CS" = 100 cases, "50 EA" = 50 each, "10 GL" = 10 gallons, "25 BX" = 25 boxes). Always look at the rightmost columns for qty and unit.
