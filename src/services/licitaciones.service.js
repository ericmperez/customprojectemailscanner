...
class LicitacionesService {
  ...
  async saveLicitacion(data) {
    try {
      ...
      logger.info(`Saved licitación to Google Sheets: ${data.emailId}`);
      return result;
    } catch (error) {
      logger.error('Error saving licitación:', error);
      throw error;
    }
  }
  ...
  async getAllLicitaciones(filters = {}) {
    try {
      ...
      logger.error('Error getting licitaciones:', error);
      throw error;
    }
  }
  ...
  async getLicitacionById(id) {
    try {
      ...
      logger.error(`Error getting licitación ${id}:`, error);
      throw error;
    }
  }
  ...
  async updateApprovalStatus(id, status, notes = '') {
    try {
      ...
      logger.info(`Updated approval status for licitación ${id}: ${status}`);
      return updated;
    } catch (error) {
      logger.error(`Error updating approval status for ${id}:`, error);
      throw error;
    }
  }
  ...
  async deleteLicitacion(id) {
    try {
      ...
      logger.info(`Deleted licitación ${id}`);
      return result;
    } catch (error) {
      logger.error(`Error deleting licitación ${id}:`, error);
      throw error;
    }
  }
  ...
  async getSiteVisitEvents(filters = {}) {
    try {
      ...
      logger.error('Error getting site visit events:', error);
      throw error;
    }
  }
}
